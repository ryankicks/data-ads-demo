...
def json_handler(request):
    ...
    return HttpResponse(json.dumps({"accounts": account_list}), content_type="application/json")
...
def handler(request):
    ...
    return render_to_response('accounts.html', context, context_instance=RequestContext(request))
